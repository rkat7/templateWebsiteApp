...
const contact: React.FC = () => {
    return (
        <Layout.Default seo={{ title: 'Get in touch' }} >
            <div className="relative flex flex-col items-center justify-center min-h-screen py-6 sm:py-12 bg-gray-100">
                <div className="relative p-6 rounded-lg max-w-md w-full text-center z-10">
                    ...
                    <div className="mb-4">
                        ...
                        <a href="mailto:kskrohith@gmail.com">
                            <button className="bg-gradient-to-r from-blue-500 to-indigo-500 text-white px-4 py-2 rounded-full hover:from-blue-600 hover:to-indigo-600 focus:outline-none focus:ring-2 focus:ring-blue-300">
                                Email Me
                            </button>
                        </a>
                    </div>
                    ...
                    <div>
                        ...
                        <a href="https://calendly.com/kskrohith" target="_blank" rel="noopener noreferrer">
                            <button className="bg-gradient-to-r from-green-500 to-teal-500 text-white px-4 py-2 rounded-full hover:from-green-600 hover:to-teal-600 focus:outline-none focus:ring-2 focus:ring-green-300">
                                Schedule a Call
                            </button>
                        </a>
                    </div>
